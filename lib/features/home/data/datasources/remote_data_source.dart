...
abstract class RemoteDataSource {
  Future<List<HomePlayBackModel>> getAllMovies();
  Future<List<GenresModel>> getAllGenres();
  Future<List<HomePlayBackModel>> getAllSeries();
  Future<List<BannerModel>> getAllBanner();
  Future<List<HomePlayBackModel>> searchMovie(String query);
...
class RemoteDataSourceImpl extends RemoteDataSource {
  ...
  @override
  Future<List<HomePlayBackModel>> getAllMovies() async {
    ...
    if (response.statusCode == 200) {
      ...
      return (data as List).map((e) => HomePlayBackModel.fromJson(e)).toList();
    } else {
      throw ServerExeption();
    }
  }
  ...
  @override
  Future<List<HomePlayBackModel>> getAllSeries() async {
...
//TODO!: убрать
  @override
  Future<List<HomePlayBackModel>> searchMovie(String query) async {
    final response =
