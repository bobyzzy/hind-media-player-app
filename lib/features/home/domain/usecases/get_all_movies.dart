...
class GetAllMovies extends Usecase<List<HomePlayBackEntity>,ParamsAllMovies> {
  final HomeRepository repository;

  GetAllMovies(this.repository);

  Future<Either<Failure, List<HomePlayBackEntity>>> call(ParamsAllMovies params) async {
