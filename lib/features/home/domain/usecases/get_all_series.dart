...
class GetAllSeries extends Usecase<List<SeriesResponseEntity>, ParamsAllSeries> {
  final HomeRepository repository;

  GetAllSeries(this.repository);
  @override
  Future<Either<Failure, List<SeriesResponseEntity>>> call(ParamsAllSeries) async {
